...
class WalletConsignorCheZhu(CheZhu):
    ...
    __add_consignor_btn = {'identifyBy': 'id', 'path': 'com.mustang:id/collections_add'}  # 新增委托代收人按钮
    __consignor_detail = {'identifyBy': 'id', 'path': 'com.mustang:id/collections_list'}
    # --*-- 新增委托代收人 --*--
    ...
    __consignor_idNo = {'identifyBy': 'ids', 'path': ['com.mustang:id/editview_et', 1]}
    __consignor_mobile = {'identifyBy': 'ids', 'path': ['com.mustang:id/editview_et', 2]}
    __consignor_confirm_btn = {'identifyBy': 'id', 'path': 'com.mustang:id/gathering_btn_open'}  # 确认开通按钮
    # --*-- 管理委托代收人 --*--
    ...
    @catch_exception
    def wait_consignor_page(self):
        wait_state = self.driver.wait_activity(activity=self.consignor_activity, timeout=20)
        return wait_state
    ...
    @catch_exception
    def find_consignor(self):
        # 列表页面是否有委托代收人
        state = self.driver.isElement(self.__consignor_detail)
        return state
