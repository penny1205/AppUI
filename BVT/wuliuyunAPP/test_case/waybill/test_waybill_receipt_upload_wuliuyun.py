...
from page_object.wuliuyun.wuliuyun_waybill.waybill_receipt_upload_wuliuyun import WaybillUploadReceiptWuliuyun
...
class TestUploadReceiptWaybill(unittest.TestCase):
    ...
    def setUp(self):
        """前置条件准备"""
        self.logger = Log()
        self.logger.info('########################### TestUploadReceiptWaybill START ###########################')
    ...
    def tearDown(self):
        ...
        self.logger.info('########################### TestUploadReceiptWaybill END ###########################')
        pass
